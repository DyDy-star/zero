#!/bin/bash
#
# 从 Solver v1 开始继续训练（Questioner v1 已完成）
# 训练流程：solver_v1 -> questioner_v2 -> solver_v2 -> questioner_v3 -> solver_v3
#

echo "=========================================="
echo "从 Solver v1 开始继续训练"
echo "=========================================="
echo ""
